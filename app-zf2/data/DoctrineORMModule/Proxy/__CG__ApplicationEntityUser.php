...
class User extends \Application\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'username', 'email', 'role', 'password', 'auths');
        }
    ...
    public function addAuth(\Application\Entity\Auth $auth)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addAuth', array($auth));

        return parent::addAuth($auth);
    }
    ...
    public function removeAuth(\Application\Entity\Auth $auth)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeAuth', array($auth));

        return parent::removeAuth($auth);
    }
    ...
    public function getAuths()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAuths', array());
